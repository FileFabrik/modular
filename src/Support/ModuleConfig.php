...
class ModuleConfig implements Arrayable
{
    ...
    public static function fromComposerFile(SplFileInfo $composer_file): self
    {
        ...
        // fix we are working with namespaced or direct module
        $name = (str_ends_with($base_path, $composer_config['name'])) ? $composer_config['name'] : basename($base_path);

        // that is the way to make internal
